            ...
            {list.map((f) => {
              ...
              return (
                <li key={f.id} className="card-soft p-3 sm:p-4">
                  <Link
                    to={`/families/${f.id}`}
                    className="flex items-start justify-between gap-2 sm:gap-3 hover:bg-muted/30 -mx-1 px-1 py-1 rounded-xl transition-colors"
                  >
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="truncate text-[11px] text-muted-foreground sm:text-[12px]">
                        {f.head}
                      </div>
                    </div>
